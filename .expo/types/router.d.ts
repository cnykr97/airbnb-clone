...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(modals)/booking` | `/booking` | `/(modals)/login` | `/login` | `/(tabs)/_layout` | `/_layout` | `/(tabs)/inbox` | `/inbox` | `/(tabs)/` | `/(tabs)` | `/(tabs)/profile` | `/profile` | `/(tabs)/trips` | `/trips` | `/(tabs)/wishlist` | `/wishlist`;
  // prettier-ignore
